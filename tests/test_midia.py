...
def test_titulo_vazio():
    with pytest.raises(ValueError):
        Midia("", "Filme", "Ação", 2012, 142, 14, "Jennifer Lawrence, Josh Hutcherson e Liam Hemsworth", "Asssistindo", 10, None)
...
def test_midia_eq():
    ...
    m2 = Midia("Dark", "Série", "Mistério", 2017, 160, 18, "Louis Hofmann, Oliver Masucci e Jördis Triebel", "Assistindo", 9.6, "2025-12-09")
    assert m1 == m2